    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-slate-900 p-4">
      <div className="w-full max-w-md space-y-8 text-center">
        <div>
          ...
          <h1 className="text-3xl font-bold text-slate-100">Schema.org Agent</h1>
          <p className="mt-2 text-slate-400">AI assistant for understanding structured data</p>
        </div>

        <div className="space-y-4 rounded-2xl border border-slate-700 bg-slate-800/50 p-8">
          <button
            onClick={() => signIn("github", { callbackUrl: "/" })}
            className="flex w-full items-center justify-center gap-3 rounded-xl bg-slate-100 py-3 font-medium text-slate-900 transition-all hover:bg-slate-200"
          >
